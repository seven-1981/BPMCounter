/****************************************************************************
** Meta object code from reading C++ file 'Log.hpp'
**
...
#error "The header file 'Log.hpp' doesn't include <QObject>."
...
const QMetaObject Log::staticMetaObject = {
    { &QPlainTextEdit::staticMetaObject, qt_meta_stringdata_Log.data,
